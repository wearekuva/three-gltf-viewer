 ...
 */
var UnrealBloomPass = function ( renderer, resolution, strength, radius, threshold ) {
    ...
    const RenderTarget = renderer.capabilities.isWebGL2 ? WebGLMultisampleRenderTarget : WebGLRenderTarget
